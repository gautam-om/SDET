...
public class TL_06_05 {
	...
	public static void main(String[] args) throws Throwable {
        ...
        System.out.println("06_03th Script Pass");
        driver.close();
      ...
      //create lead image
        ...
        // select by index 
        WebElement sarname1 = driver.findElement(By.name("salutationtype"));
        wdu.selectOption(sarname1, 8);
...
//      title.sendKeys("Dxc",Keys.TAB,"5",Keys.TAB,"ravi@dxc.com");
        ...
        System.out.println("06_02th Script Pass");
        //driver.close();
